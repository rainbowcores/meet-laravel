    ...
    <form action="" method="post" class="form-horizontal">
      ...
      <fieldset>
            ...
            <div class="form-group">
              ...
              <select multiple class="form-control" id="location" name="location" placeholder="location" class="form-control input-md" value="{{ $rooms->location}}" required="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                <select multiple class="form-control" id="availability_status" name="availability_status" placeholder="room availability status" class="form-control input-md" value="{{ $rooms->availability_status}}" required="">
